...
export class DeviceModelComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.deviceModelService
      ...
      .subscribe((res: HttpResponse<IDeviceModel[]>) => this.paginateDeviceModels(res.body, res.headers));
  }
  ...
  trackId(index: number, item: IDeviceModel) {
    return item.id;
  }
  ...
  protected paginateDeviceModels(data: IDeviceModel[], headers: HttpHeaders) {
