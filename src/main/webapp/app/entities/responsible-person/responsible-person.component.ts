...
export class ResponsiblePersonComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.responsiblePersonService
      ...
      .subscribe((res: HttpResponse<IResponsiblePerson[]>) => this.paginateResponsiblePeople(res.body, res.headers));
  }
  ...
  trackId(index: number, item: IResponsiblePerson) {
    return item.id;
  }

  registerChangeInResponsiblePeople() {
    this.eventSubscriber = this.eventManager.subscribe('responsiblePersonListModification', () => this.loadAll());
  }
  ...
  protected paginateResponsiblePeople(data: IResponsiblePerson[], headers: HttpHeaders) {
