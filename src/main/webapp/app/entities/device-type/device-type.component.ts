...
export class DeviceTypeComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.deviceTypeService
      ...
      .subscribe((res: HttpResponse<IDeviceType[]>) => this.paginateDeviceTypes(res.body, res.headers));
  }
  ...
  trackId(index: number, item: IDeviceType) {
    return item.id;
  }
  ...
  protected paginateDeviceTypes(data: IDeviceType[], headers: HttpHeaders) {
