...
import { DeviceSettingComponent } from 'app/entities/device-setting/device-setting.component';
...
describe('Component Tests', () => {
  describe('DeviceSetting Management Component', () => {
    let comp: DeviceSettingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DeviceSettingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.deviceSettings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
