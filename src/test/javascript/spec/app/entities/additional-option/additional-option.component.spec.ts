...
import { AdditionalOptionComponent } from 'app/entities/additional-option/additional-option.component';
...
describe('Component Tests', () => {
  describe('AdditionalOption Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.additionalOptions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
