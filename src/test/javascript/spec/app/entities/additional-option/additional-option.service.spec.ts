...
describe('Service Tests', () => {
  describe('AdditionalOption Service', () => {
    ...
    let elemDefault: IAdditionalOption;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(AdditionalOptionService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new AdditionalOption(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a AdditionalOption', () => {
        ...
        service
          .create(new AdditionalOption(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
